...
- You may optionally call additional tools for deeper analysis:
  - `get_balance_sheet` for detailed asset/liability analysis
  - `get_cashflow` for cash flow statement analysis
  - `get_income_statement` for revenue and profit details
...
2. Optionally call other financial statement tools for deeper insights.
